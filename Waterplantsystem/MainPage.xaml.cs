...
namespace Waterplantsystem
{
    public sealed partial class MainPage : Page
    {
        ...
        private void setup()
        {
            ...
            loopTimer.Interval = TimeSpan.FromMilliseconds(5000);
        ...
        private void textMain(object sender, object e)
        {
            ...
            ConnectTheDotsSensor sensor1 = ctdHelper1.sensors.Find(item => item.measurename == "Temperature");
            sensor1.value = Tem;
            ...
            ConnectTheDotsSensor sensor2 = ctdHelper2.sensors.Find(item => item.measurename == "light");
            sensor2.value = Ambient_light;
            ...
            ConnectTheDotsSensor sensor3 = ctdHelper3.sensors.Find(item => item.measurename == "humidity");
            sensor3.value = Moisture;
            ctdHelper3.SendSensorData(sensor3);

            Debug.WriteLine("Temp:" + Temperature + ", Light:" + Ambient_light + ", Moisture:" + Moisture);
        }
